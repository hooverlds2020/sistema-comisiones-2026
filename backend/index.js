...
// ==========================================
// CONFIGURACIÃ“N DE MULTER (SUBIDA DE MEMBRETES)
// ==========================================
...
pool.query('SELECT NOW()', (err, res) => {
  if (err) console.error('âŒ Error de conexiÃ³n a DB:', err.message);
  else console.log('âœ… ConexiÃ³n exitosa a PostgreSQL');
});
...
const enviarAlertaTelegram = async (mensaje) => {
  ...
  try {
    ...
    console.error("âŒ Error enviando Telegram:", error.message);
  }
};
