...
const FilaUnFirma = ({ nombre, cargo, altura }) => (
  <View style={{ flexDirection: 'row', borderBottomWidth: 0, borderColor: '#000', height: altura, alignItems: 'flex-end', justifyContent: 'center' }}>
    <View style={{ width: '50%', height: '100%' }}><Firma nombre={nombre} cargo={cargo} /></View>
  </View>
);

const Plantilla3Firmas = ({ data, autoridades = [] }) => {
  if (!data) return null;
      ...
      <Page size="LETTER" style={styles.page}>
        ...
        <View style={styles.mainTable}>
          ...
          <View style={{ flexShrink: 0 }}>
            <FirmaHeader left="COMISIONADO" />
            <FilaUnFirma nombre={comisionadoNombre} cargo={categoriaComisionado} altura={firmaH} />
            <FirmaHeader left="AUTORIZA" right="Vo. Bo." />
...
export default Plantilla3Firmas;
